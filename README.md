...
:--:|:--:|:--:
[![](./images/time-chart.png)](./widgets/time-chart/README.md) | [![](./images/gauge-chart.png)](./widgets/gauge-chart.png) | [![](./images/bar-chart.png)](./widgets/bar-chart.png)

Histogram Chart | Box Chart | Calendar Chart
:--:|:--:|:--:
[![](./images/histogram.png)](./widgets/histogram.png) | ![](./images/box-chart.png) | ![](./images/calendar-chart.png)
