...
<a name="column-key"></a>[`column-{key}`](#column-key)| Change the name of column `{key}`.<br>Hide `column-{key}` with `column-{key} = null`.<br>**Example**: `column-entity = Entity`.| [↗](https://apps.axibase.com/chartlab/77a78ad8)
...
<a name="format"></a>[`format`](#format)| Time value format.<br>**Example**: `format = %H:%M:%S`.| [↗](https://apps.axibase.com/chartlab/d9abcd33)
<a name="merge-columns"></a>[`merge-columns`](#merge-columns)| Group columns by key.<br>**Example**: `merge-columns = entity, tags`.| [↗](https://apps.axibase.com/chartlab/cd464c8e)
...
<a name="format"></a>[`format`](#format)|Cell value [format](../../syntax/format-settings.md).<br>**Example**: `format = kilobytes`.|[↗](https://apps.axibase.com/chartlab/95bd95be/8/)
...
<a name="style"></a>[`style`](#style)|Style assigned to the column.<br>Can be specified as JavaScript code.<br>**Example**: `style = text-align: left`.|[↗](https://apps.axibase.com/chartlab/95bd95be/23/)
...
<a name="onclick"></a>[`onclick`](#onclick)|JavaScript code click event handler for each cell.<br>Supports `method` filter, which allows you to filter the rows in the table to the value of this cell.<br>**Example**: `onclick = var s = series({ metric: 'nmon.process.%cpu', disconnectInterval: '90 second' })`.|[↗](https://apps.axibase.com/chartlab/95bd95be/15/)
