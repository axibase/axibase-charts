...
<a name="gradient-count"></a>[`gradient-count`](#gradient-count) | `gradient-count = 2` | Amount of gradient colors between each color defined by `color-range`. | [↗](https://apps.axibase.com/chartlab/ac1b1044)
