...
<a name="format-headers"></a>[`format-headers`](#format-headers)| Format column headers.<br>Possible values: `true`, `false`.<br>Default value: `false`.<br>**Example**: `format-headers = true`| [↗](https://apps.axibase.com/chartlab/47565e08/2/)
