...
<a name="arrows"></a>[`arrows`](#arrows)| Arrows on the directed edges<br>Possible values: `false`, `true`.<br>Default value: `false`.<br>**Example**: `arrows = true`.|[↗]()
...
<a name="node-labels"></a>[`node-labels`](#node-labels)|Display vertex labels.<br>Possible values: `false`, `true`.<br>Default value: `true`.<br>**Example**: `node-labels = false`.|[↗]()
<a name="link-labels"></a>[`link-labels`](#link-labels)|Display edge labels.<br>Possible values: `false`, `true`.<br>Default value: `true`.<br>**Example**: `link-labels = false`.|[↗]()
