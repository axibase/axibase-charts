...
<a name="panels-interval"></a>[`panels-interval`](#panels-interval)|  Override aggregation period selectors used by statistical functions in the **top right** corner. |[↗](https://apps.axibase.com/chartlab/3212079e/6/)
