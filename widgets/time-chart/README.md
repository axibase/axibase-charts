...
<a name="retain-time-span"></a>[`retain-time-span`](#retain-time-span) | `retain-time-span = false` | Preserve widget `timespan` as new data is added.<br>Possible values: `false`, `true`<br>Default value: `true`.| [↗](https://apps.axibase.com/chartlab/48eed908)
