...
<a name="periods"></a>[`periods`](#periods)|  Custom aggregation periods in widget controls.<br>Specified as the number of [time units](https://axibase.com/docs/atsd/api/data/series/time-unit.html).<br>Possible values: `count time_unit`.<br>**Example**: `periods = 20 minute, 4 hour`. |  [↗](https://apps.axibase.com/chartlab/eaf88286)
