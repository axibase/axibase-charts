...
Name | Example | Description | &nbsp;
:--|:--|:--|:--
<a name="display"></a>[`display`](#display) | `display = value >= top(3)` | Display expression.<br>Refer to [Expression Syntax Documentation](https://axibase.com/docs/atsd/administration/metric-persistence-filter.html#expression-syntax) for more information.| [↗](https://apps.axibase.com/chartlab/9371863ft)
