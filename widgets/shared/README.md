...
[`format-labels`](#format-labels)| `label-format = tagName`<br>`label-format = statistics - period` | Series labels.<br>Possible values:<br><li>Text<br><li>Chart component placeholders (see example configuration).<br>Refer to [Label Formating](../../syntax/label-formatting.md) for possible values.| [↗](https://apps.axibase.com/chartlab/f2bed31b)
[`day-format`](#day-format) | `day-format = %y/%m/%d`| `x` axis timestamp format.<br>Combine values as needed.<br>Possible values:<br><li>`%a`: Three-letter day of the week name.<br><li>`%A`: Full day of the week name.<br><li>`%b`: Three-letter month name.<br><li>`%B`: Full month name.<br><li>`%c`: `Mon Sep 17 00:00:00 2018`<br><li>`%d`: Date of month such as `17`.<br><li>`%e`: Date of month such as `17`<br><li>`%H`: Two-digit 24-hour hour.<br><li>`%I`: Two-digit 12-hour hour.<br><li>`%j`: Numerical day of the year, `1` through `365` or `366`.<br><li>`%L`: Timestamp nanoseconds.<br><li>`%m`: Numerical month, `1` through `12`.<br><li>`%p`: `AM` or `PM` 12-hour time designation.<br><li>`%S`: Timestamp seconds.<br><li>`%U`: Numerical week of the year, `1` through `52`.<br><li>`%w`: Numerical day of the week, `0` though `6` beginning with Sunday.<br><li>`%W`: Numerical week of the year, `1` through `52`.<br><li>`%x`: `09/17/2018`<br>`%X`: Numerical time of the day in `hours:minutes:seconds` (`00:00:00`) format.<br><li>`%y`: Two-digit year.<br><li>`%Y`: Four-digit year.<br><li>`%Z`: Time zone offset from UTC.| [↗](https://apps.axibase.com/chartlab/40dafe6b/2/)
