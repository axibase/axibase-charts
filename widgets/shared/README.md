...
<a name="start-working-minutes"></a>[`start-working-minutes`](#start-working-minutes)| Working date start time, in minutes. If working day starts at `9:30` then start can be specified as `570 = 9 * 60 + 30`.<br>Applied only if [`statistic`](#statistics) is one of [`THRESHOLD_*`](https://axibase.com/docs/atsd/api/data/series/examples/query-aggr-threshold.html#series-query-threshold-aggregators) functions. <br>**Example**: `start-working-minutes = 570`| [↗](https://apps.axibase.com/chartlab/de76132b/4/)
<a name="end-working-minutes"></a>[`end-working-minutes`](#end-working-minutes)| Working date end time, in minutes. If working day ends at `12:30` then end can be specified as `750 = 12 * 60 + 30`.<br>Applied only if [`statistic`](#statistics) is one of [`THRESHOLD_*`](https://axibase.com/docs/atsd/api/data/series/examples/query-aggr-threshold.html#series-query-threshold-aggregators) functions. <br>**Example**: `end-working-minutes = 750`| [↗](https://apps.axibase.com/chartlab/de76132b/4/)
...
<a name="group-place-constraint"></a>[`group-place-constraint`](#group-place-constraint)| Boolean expression that series in each subgroup must satisfy.<br>**Example**: `group-place-constraint = max() < 10`| [↗](https://apps.axibase.com/chartlab/2c3166de/5/)
<a name="group-place-count"></a>[`group-place-count`](#group-place-count)| Maximum number of subgroups. The response can contain less than the maximum.<br>**Example**: `group-place-count = 5`| [↗](https://apps.axibase.com/chartlab/2c3166de/5/)
<a name="group-place-minimize"></a>[`group-place-minimize`](#group-place-minimize)| Objective [function](https://axibase.com/docs/atsd/api/data/series/group.html#functions-available-in-the-place-context) calculated for each subgroup. Partitioning into subgroups is performed to minimize the sum of function values.<br>**Example**: `group-place-minimize = stdev()`| [↗](https://apps.axibase.com/chartlab/2c3166de/5/)
...
<a name="group-place-method"></a>[`group-place-method`](#group-place-method)| The algorithm used to solve the [packing](https://axibase.com/docs/atsd/api/data/series/group.html#packing) problem.<br>Possible values: `greedy_correlations`, `greedy_simple`.<br>Default value: `greedy_simple`.<br>**Example**: `group-place-method = greedy_correlations`| [↗](https://apps.axibase.com/chartlab/8c052e61/2/)
<a name="group-place-entities"></a>[`group-place-entities`](#group-place-entities)| Entities containing group-specific information using entity tags with numeric characteristics of a subgroup.<br>**Example**: `group-place-entities = lp_group_1, lp_group_2`| [↗](https://apps.axibase.com/chartlab/ee0d0397/3/)
<a name="group-place-entity-group"></a>[`group-place-entity-group`](#group-place-entity-group)| Alternative to `entities` setting using an [entity group](https://axibase.com/docs/atsd/api/meta/entity-group/) name.<br>**Example**: `group-place-entity-group = servers`| [↗](https://apps.axibase.com/chartlab/8c052e61/2/)
<a name="group-place-entity-expression"></a>[`group-place-entity-expression`](#group-place-entity-expression)| Alternative to `entities` setting using an [expression](https://axibase.com/docs/atsd/api/data/filter-entity.html#entityexpression-syntax).<br>**Example**: `group-place-entity-expression = nur*`| [↗](https://apps.axibase.com/chartlab/8c052e61/2/)
<a name="group-keys"></a>[`group-keys`](#group-keys)|List of keys including `entity`, `type`, `source`, and custom tags to [count messages](https://axibase.com/docs/atsd/api/data/messages/stats.html#calculation-fields) by period.<br>**Example**:<br>`group-keys = type`<br>`group-keys = entity, type`| [↗](https://apps.axibase.com/chartlab/bf166165)
...
Name | Description | &nbsp;
:--|:--|:--
<a name="alias"></a>[`alias`](#alias)| Unique series name to pass data to other series. Used as default label if no [`label`](#label) and [`label-format`](#label-format) settings are specified. <br>**Example**: `alias = s1`| [↗](https://apps.axibase.com/chartlab/a18e5720/2/)
