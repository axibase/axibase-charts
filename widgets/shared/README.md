...
[`offset-left`](#offset-left) | `offset-left = 50` | Offset from left boundary, in units. | [↗](https://apps.axibase.com/chartlab/720677c3)
[`offset-top`](#offset-top) | `offset-top = 50` | Offset from top boundary, in units. | [↗](https://apps.axibase.com/chartlab/011dd3f6)
...
[`range`](#range) | `max-range = 40`<br>`min-range = 10`| Left axis minimum and maximum range.<br>Loaded data samples can violate defined range.| [↗](https://apps.axibase.com/chartlab/389fc36a)
[`range-right`](#range-right) | `max-range-right = 250`<br>`min-range-right = 50` | Right axis minimum and maximum range.<br>Loaded data samples can violate defined range.| [↗](https://apps.axibase.com/chartlab/1732e258)
[`force-range`](#force-range) | `min-range-force = 0`<br>`max-range-force = 100` | Left axis forced minimum and maximum range.<br>Loaded data samples cannot violate defined range. | [↗](https://apps.axibase.com/chartlab/fa0b58a7)
[`force-range-right`](#force-range-right) | `min-range-right-force = 0`<br>`max-range-right-force = 100` | Right axis forced minimum and maximum range.<br>Loaded data samples cannot violate defined range. | [↗](https://apps.axibase.com/chartlab/d80980a8/9/)
...
[`axis-title`](#axis-title) | `axis-title = CPU Utilization in %`<br>`axis-title-right = Free Memory in KB`| Left and right axes labels.| [↗](https://apps.axibase.com/chartlab/d8adfe73)
...
[`format-labels`](#format-labels)| `label-format = tagName`<br>`label-format = statistics - period` | Series labels.<br>Possible values:<br><li>Text<br><li>Placeholder for chart components (see example configuration).<br>Refer to [Label Formating](../../syntax/label-formatting.md) for possible values.| [↗](https://apps.axibase.com/chartlab/f2bed31b)
[`date-format`](#date-format) | `day-format = %y/%m/%d`| `x` axis timestamp format.| [↗](https://apps.axibase.com/chartlab/40dafe6b/2/)
[`cache`](#cache) | `cache = true` | Retrieve only the most recent value from HBase **Last Insert** table.| [↗](https://apps.axibase.com/chartlab/032bcfcc)
...
`table` | `table = KLZ_CPU_Averages`| Alternative to `metric` setting.<br>Both `table` and `attribute` must be defined.<br>`metric = table,attribute`.| [↗](https://apps.axibase.com/chartlab/35fde2bf)
`attribute` | `attribute = CPU_Usage_Current_Average` | Second component of `table`/`attribute` metric declaration. | [↗](https://apps.axibase.com/chartlab/35fde2bf)
...
[`entity-expression`](#entity-expression) | `entity-expression = tags.app like '*a*'` | Server-side filter for all series by entity names, tags, and fields.| [↗](https://apps.axibase.com/chartlab/ffc97c51)
[`tag-expression`](#tag-expression)| `tag-expression = tags.make.toLowerCase().indexOf('as') >= 0`| Server-side filter for [series tags](https://axibase.com/docs/atsd/api/meta/metric/series-tags.html).| [↗](https://apps.axibase.com/chartlab/135a3458)
[`statistics`](#statistics) | `statistic = avg`| Aggregation statistic functions.<br>Refer to [Aggregators Documentation](../../configuration/aggregators.md) for more information.| [↗](https://apps.axibase.com/chartlab/0143f4e7)
[`period`](#period) | `period = 15 minute`| [Aggregator](https://axibase.com/docs/atsd/api/data/series/aggregate.html#aggregate-processor) period.<br>Possible values:<br><li>`auto`<br><li>[Time Unit](https://axibase.com/docs/atsd/api/data/series/time-unit.html)| [↗](https://apps.axibase.com/chartlab/661181a3)
...
[`smooth-factor`](#smooth-range) | `smooth-factor = 0.5` | `EMA` function weight parameter. Possible values:<br><li>Number between `0` and `1`. | [↗](https://apps.axibase.com/chartlab/3734bd35/4)|
...
Name | Example | Description | &nbsp;
:--|:--|:--|:--
[`style`](#style) | `style = stroke-width: 4;`<br>`style = padding: 50`<br>`style = stroke-dasharray: none;` | Series CSS style. | [↗](https://apps.axibase.com/chartlab/fb6d13d9)<br>[↗](https://apps.axibase.com/chartlab/6d91d52f) [↗](https://apps.axibase.com/chartlab/5e47cfbe)
...
[`refresh-interval`](#refresh-interval) | `refresh-interval = 120` |Period in seconds to refresh data. <br>Possible values:<br><li>`auto`<br><li> Number | [↗](https://apps.axibase.com/chartlab/da03b8a5/24/)
