...
Name | Description | &nbsp;
:--|:--|:--
<a name="alias"></a>[`alias`](#alias)| Unique series name to pass data to other series. Used as default label if no [`label`](#label) and [`label-format`](#label-format) settings are specified. <br>**Example**: `alias = s1`| [↗](https://apps.axibase.com/chartlab/a18e5720)
