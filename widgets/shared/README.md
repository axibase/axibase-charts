...
<a name="timezone"></a>[`timezone`](#timezone)| [Time Zone ID](https://axibase.com/docs/atsd/shared/timezone-list.html#full-list), in which [`start-time`](#start-time) and [`end-time`](#end-time) are must be evaluated, or `local`. [Influences](https://apps.axibase.com/chartlab/f7d0a5c1/2/) on time axis formatting.<br>Default value: `local`.<br>**Example**: `timezone = America/Toronto`| [↗](https://apps.axibase.com/chartlab/79d67d43)
