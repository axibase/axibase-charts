...
* <a name="delta"></a>[`delta`](../widgets/time-chart/README.md#delta)
* <a name="delta-percent"></a>[`delta-percent`](../widgets/time-chart/README.md#delta-percent)
...
* <a name="fix-start-time"></a>[`fix-start-time`](../widgets/shared/README.md#filter)
...
* <a name="group-place-minimize"></a>[`group-place-minimize`](../widgets/shared/README.md#group-place-minimize)
* <a name="group-place-method"></a>[`group-place-method`](../widgets/shared/README.md#group-place-method)
* <a name="group-place-entities"></a>[`group-place-entities`](../widgets/shared/README.md#group-place-entities)
* <a name="group-place-entity-group"></a>[`group-place-entity-group`](../widgets/shared/README.md#group-place-entity-group)
* <a name="group-place-entity-expression"></a>[`group-place-entity-expression`](../widgets/shared/README.md#group-place-entity-expression)
* <a name="group-statistic"></a>[`group-statistic`](../widgets/shared/README.md#group-statistic)
* <a name="group-tags"></a>[`group-tags`](../widgets/shared/README.md#group-tags)
...
* <a name="max"></a>[`max`](../widgets/time-chart/README.md#max)
...
* <a name="max-force"></a>[`max-force`](../widgets/time-chart/README.md#max-force)
...
* <a name="min"></a>[`min`](../widgets/time-chart/README.md#min)
* <a name="min-insert-time"></a>[`min-insert-time`](../widgets/shared/README.md#min-insert-time)
* <a name="min-force"></a>[`min-force`](../widgets/time-chart/README.md#min-force)
...
* <a name="null-columns"></a>[`null-columns`](../widgets/shared-table/README.md#null-columns)
...
* <a name="on-title-click"></a>[`on-title-click`](../widgets/shared/README.md#on-title-click)
...
* <a name="panels-statistics"></a>[`panels-statistics`](../widgets/time-chart/README.md#panels-statistics)
* <a name="panels-period"></a>[`panels-period`](../widgets/time-chart/README.md#panels-period)
...
* <a name="primary-key"></a>[`primary-key`](../widgets/alert-table/README.md#primary-key)
...
* <a name="right"></a>[`right`](../widgets/time-chart/README.md#right)
...
* <a name="ticks-axis"></a>[`ticks` in `[axis]`](../widgets/time-chart/README.md#ticks)
...
* <a name="title-axis"></a>[`title` in `[axis]`](../widgets/time-chart/README.md#title)
